...
class GameRoundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create game_round" do
    assert_difference('GameRound.count') do
      post game_rounds_url, params: { game_round: { date: @game_round.date, player: @game_round.player, score: @game_round.score } }, as: :json
    end
  ...
  test "should update game_round" do
    patch game_round_url(@game_round), params: { game_round: { date: @game_round.date, player: @game_round.player, score: @game_round.score } }, as: :json
    assert_response 200
  end
